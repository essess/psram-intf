...
-- Module  Version: 7.5
--C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n ramdq -lang vhdl -synth lse -bus_exp 7 -bb -arch xo3c00f -type bram -wp 10 -rp 1000 -addr_width 8 -data_width 8 -num_rows 256 -cascade -1 -mem_init0 -init_data DYNAMIC -writemode NORMAL 
...
architecture Structure of ramdq is
    ...
    attribute MEM_LPC_FILE of ramdq_0_0_0 : label is "ramdq.lpc";
    attribute MEM_INIT_FILE of ramdq_0_0_0 : label is "INIT_ALL_0s";
...
-- synopsys translate_off
library MACHXO3L;
configuration Structure_CON of ramdq is
    for Structure
